...
import { createMeetingAction } from "@/app/lib/action";
    ...
    <div className="min-h-screen w-screen flex items-center jusityf-center">
      {showForm ? (
        <Card className="max-w-[600px] w-full mx-auto">
          <CardHeader>
            <CardTitle>
              Booking for {data.title} by {data.user?.name}
            </CardTitle>
            <CardDescription>
              Please review the details below and select a time slot that works
              for you.
            </CardDescription>
        ...
        <Card className="max-w-[1000px] w-full mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              This is the booking page for the event. You can customize it
